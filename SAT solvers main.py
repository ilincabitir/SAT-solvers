...
def dp_solver(clauses, p=False):
    '''
   Solves the SAT problem using the DP algorithm,
   applying unit clause and pure literal rules.
   If these simplifications are not enough to solve the formula,
   it goes back to the resolution_solver.
    '''
...
###### MAIN #######
file_name = "test cases/Small Tests/C1.1.txt"
